...
minify ./src/js/core.berry.js ./src/js/field.berry.js  ./src/js/events.berry.js ./src/js/init.berry.js  ./src/js/duplicate.berry.js ./src/js/conditions.berry.js  ./src/js/validations.berry.js ./src/js/fields/*.js > ./bin/berry.min.js
