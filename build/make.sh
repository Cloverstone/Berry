...
minify ./src/js/base.berry.js ./src/js/field.berry.js  ./src/js/events.berry.js ./src/js/core.berry.js ./src/js/duplicate.berry.js ./src/js/conditions.berry.js  ./src/js/validations.berry.js ./src/js/fields/*.js ./src/js/enhance/*.js ./src/js/advanced/*.js ./src/js/render/*.js > ./bin/full.berry.min.js
