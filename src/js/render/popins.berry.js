...
Berry.prototype.events.initialize.push({
	...
	func: function(){
		...
		$.extend(this.options.default,{hideLabel: true});
			...
			// }
			 // this.on('change', function() { this.trigger('save'); });
		}
	}
});